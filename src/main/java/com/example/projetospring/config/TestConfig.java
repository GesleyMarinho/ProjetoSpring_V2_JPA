...
import com.example.projetospring.enums.OrderStatus;
import com.example.projetospring.repositories.CategoryRepository;
import com.example.projetospring.repositories.OrderRepository;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"), OrderStatus.CANCELLED, u2);
